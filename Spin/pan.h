...
#define _nstates14	11	/* digito3 */
#define minseq14	209
#define maxseq14	218
#define _endstate14	10

#define _nstates13	11	/* digito2 */
#define minseq13	199
#define maxseq13	208
#define _endstate13	10

#define _nstates12	11	/* digito1 */
#define minseq12	189
#define maxseq12	198
#define _endstate12	10

#define _nstates11	11	/* activar_alarma */
#define minseq11	179
#define maxseq11	188
#define _endstate11	10

#define _nstates10	11	/* parar_alarma */
#define minseq10	169
#define maxseq10	178
#define _endstate10	10

#define _nstates9	11	/* inactiva_no_suena */
#define minseq9	159
#define maxseq9	168
#define _endstate9	10

#define _nstates8	14	/* presencia_activa */
#define minseq8	146
#define maxseq8	158
#define _endstate8	13

#define _nstates7	11	/* luz_tiempo_apaga */
#define minseq7	136
#define maxseq7	145
#define _endstate7	10

#define _nstates6	11	/* alguien_enciende */
#define minseq6	126
#define maxseq6	135
#define _endstate6	10

#define _nstates5	11	/* entorno_code */
#define minseq5	116
#define maxseq5	125
#define _endstate5	10

#define _nstates4	46	/* code */
#define minseq4	71
#define maxseq4	115
#define _endstate4	45

#define _nstates3	10	/* entorno_alarm */
#define minseq3	62
#define maxseq3	70
#define _endstate3	9

#define _nstates2	28	/* alarm */
#define minseq2	35
#define maxseq2	61
#define _endstate2	27

#define _nstates1	12	/* entorno_light */
#define minseq1	24
#define maxseq1	34
#define _endstate1	11

#define _nstates0	25	/* ligth */
#define minseq0	0
#define maxseq0	23
...
typedef struct P11 { /* activar_alarma */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P10 { /* parar_alarma */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P9 { /* inactiva_no_suena */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P8 { /* presencia_activa */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P7 { /* luz_tiempo_apaga */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P6 { /* alguien_enciende */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Pentorno_code	((P5 *)this)
typedef struct P5 { /* entorno_code */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Pcode	((P4 *)this)
typedef struct P4 { /* code */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Pentorno_alarm	((P3 *)this)
typedef struct P3 { /* entorno_alarm */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Palarm	((P2 *)this)
typedef struct P2 { /* alarm */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Pentorno_light	((P1 *)this)
typedef struct P1 { /* entorno_light */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Pligth	((P0 *)this)
typedef struct P0 { /* ligth */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define HAS_TRACK	0
/* hidden variable: */	int buzzer;
/* hidden variable: */	int comprueba;
#define FORWARD_MOVES	"pan.m"
#define BACKWARD_MOVES	"pan.b"
#define TRANSITIONS	"pan.t"
#define _NP_	15
#define _nstates15	3 /* np_ */
#define _endstate15	2 /* np_ */

#define _start15	0 /* np_ */
#define _start14	6
#define _start13	6
#define _start12	6
#define _start11	6
